...
@patch("subprocess.run")
@patch("shutil.which")
def test_restart_media_server_with_docker(mock_which: MagicMock, mock_run: MagicMock, monkeypatch):
...
@patch("subprocess.run")
@patch("shutil.which")
def test_restart_media_server_no_docker(mock_which: MagicMock, mock_run: MagicMock, monkeypatch):
...
@patch("subprocess.run")
@patch("shutil.which")
def test_restart_media_server_docker_failure(mock_which: MagicMock, mock_run: MagicMock, monkeypatch):
